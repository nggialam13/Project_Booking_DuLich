            ...
            <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
                ...
                <div class="bg-primary bg-gradient p-4 text-white text-center">
                    <div class="position-relative d-inline-block">
                        ...
                        @else
                            <div class="rounded-circle bg-white text-primary d-inline-flex align-items-center justify-content-center shadow-sm" 
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fw-semibold">{{ $user->dob ? $user->dob->format('d/m/Y') : 'Chưa cập nhật' }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
