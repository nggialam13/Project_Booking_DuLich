...
class TourSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($tours as &$tour) {
            $startDate = \Carbon\Carbon::today()->addDays(random_int(1, 60));
            $endDate = $startDate->copy()->addDays(random_int(1, 5));

            $tour['start_date'] = $startDate->toDateString();
            $tour['end_date'] = $endDate->toDateString();

            $tour['duration'] = abs($endDate->diffInDays($startDate)) + 1;
            $tour['available_slots'] = $tour['slots'];
        }
